...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="py-8 sm:py-12 lg:py-16 relative border-t border-blue-500/20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12">
          ...
          <div className="space-y-3 sm:space-y-4 flex-1 max-w-md">
            <div className="flex items-center space-x-2">
              <Code2 size={20} className="text-blue-500 dark:text-blue-400 sm:w-6 sm:h-6" />
          ...
          <div className="space-y-3 sm:space-y-4 flex-shrink-0">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="text-slate-600 dark:text-gray-300 text-sm sm:text-base">{t("footer.availability")}</div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-3 lg:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-2 text-slate-600 dark:text-gray-300 text-center sm:text-left">
              <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <Heart size={14} className="text-red-400 animate-pulse sm:w-4 sm:h-4" />
              </div>
              <span className="text-sm sm:text-base">{t("footer.coffeeMessage")}</span>
            </div>
