      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {stackCategories.map((category, index) => (
            ...
            >
              <div className="border border-blue-500/30 rounded-lg p-4 sm:p-6 bg-slate-100/50 dark:bg-slate-900/50 backdrop-blur-sm hover:bg-slate-200/70 dark:hover:bg-slate-900/70 transition-all duration-300 h-full hover:scale-105">
                <div
                  className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gradient-to-r ${category.color} p-2 sm:p-3 mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  <category.icon
                    size={20}
                ...
                <h3
                  className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-foreground group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors duration-300"
                  data-cursor="text"
                >
                  {t(category.titleKey)}
                </h3>
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  {category.technologies.map((tech, techIndex) => (
                    ...
                    >
                      ...
                      <span
                        className="text-slate-600 dark:text-gray-300 group-hover/tech:text-foreground transition-colors duration-200 text-sm sm:text-base"
                        data-cursor="text"
                      >
                        {tech}
                      </span>
        ...
        <div className="mt-8 sm:mt-12 lg:mt-16 text-center">
          <div className="border border-blue-500/30 rounded-lg p-4 sm:p-6 lg:p-8 bg-slate-100/30 dark:bg-slate-900/30 backdrop-blur-sm max-w-4xl mx-auto">
            <h3
              className="text-lg sm:text-xl lg:text-2xl font-bold mb-3 sm:mb-4 text-blue-500 dark:text-blue-400"
              data-cursor="text"
            >
              {t("stack.continuousLearning")}
            </h3>
            <p
              className="text-slate-600 dark:text-gray-300 text-base sm:text-lg leading-relaxed"
              data-cursor="text"
            >
