...
function PrimaryButton({
  ...
  const baseClasses =
    "inline-flex items-center px-4 sm:px-6 lg:px-8 py-2 sm:py-3 border border-blue-500 text-blue-500 dark:[--card-bg] hover:bg-[card-bg] hover:!text-[--zed-light] transition-all duration-300 rounded-lg text-sm sm:text-base";
